...
func (s *Server) handleIndex(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, map[string]any{
		...
		"routes": map[string]string{
			...
			"POST /run/bootstrap":      "A — account, company, PA, settings, usage",
			...
			"POST /run/accounting":     "I — reporting, exports, e-reporting, archives, notifications",
			"POST /run/administration": "J — api keys, members, billing, RGPD",
